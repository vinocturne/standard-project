         ...
         <div class="content_wrap inner">
             ...
             <div class="register_wrap">
                ...
                <div class="content-box typeThinBg gStrong">
                    <p><span class="content-chk"><input type="checkbox" id="sAgreeAllChecked"><em class="checkbox"></em></span>
                ...
                <div class="content-box typeThinBg agreeArea ">
                    ...
                    <ul class="check">
                    <li class="">
                    <br> <span> SMS 수신을 동의하십니까?</span> <input id="is_sms0" name="is_sms" fw-label="is_sms" fw-msg="" class="ec-base-chk" value="T" type="checkbox"><label for="is_sms0">동의함</label>            </li>
                    <li class="">
                ...
                <br><a href><img src="../img/member_join.png" width="145" height="45" alt="회원가입"></a> 
                </div>
            </div>
