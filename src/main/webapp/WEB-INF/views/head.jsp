...
<link rel="stylesheet" media="(max-width:1257px)" href="<%=request.getContextPath()%>/ResourcesFile/css/main_medium.css">
<link rel="stylesheet" media="(max-width:1257px)" href="<%=request.getContextPath()%>/ResourcesFile/css/main_small.css">
