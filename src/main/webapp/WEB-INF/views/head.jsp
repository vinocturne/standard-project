...
<link rel="stylesheet" media="(max-width:1185px)" href="<%=request.getContextPath()%>/ResourcesFile/css/main_medium.css">
<link rel="stylesheet" media="(max-width:1024px)" href="<%=request.getContextPath()%>/ResourcesFile/css/main_small.css">
