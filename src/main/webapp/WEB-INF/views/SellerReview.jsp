...
<head>
   <meta charset="UTF-8">
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/webapp/ResourcesFile/css/reset.css">
	<link rel="stylesheet" href="<%=request.getContextPath()%>/webapp/ResourcesFile/css/style.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/webapp/ResourcesFile/css/seller.css">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/webapp/ResourcesFile/css/SellerReview.css">
